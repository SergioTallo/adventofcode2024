...
from utils_for_adventofcode.line_manipulation import readlines, transform_to_list_of_int
...
def transform_lists(input_file: str):
    lines = transform_to_list_of_int(readlines(input_file=input_file))
...
def calculate_distance(input_file: str):
    first_column, second_column = transform_lists(input_file=input_file)
    total_distance = 0
